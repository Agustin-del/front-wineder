...
const Admin = () => {
    return (
        <div>
            ...
            <div class="md:flex flex items-center flex-col md:flex-row" >
                <ul class="flex-column w-[60%]  space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
                    <li>
                        <a href="#" class="inline-flex items-center px-4 py-3 text-white bg-[#5e2a30] rounded-lg active w-full dark:bg-blue-600" aria-current="page">
                    ...
                    <li>
                        <a href="#" class="inline-flex items-center px-4 py-3 text-white bg-[#5e2a30] rounded-lg active w-full dark:bg-blue-600">
