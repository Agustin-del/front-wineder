                ...
                <div className="bg-[#F0E9E1] ">
                    ...
                    <div className="bg-cover object-cover bg-center pt-16 h-[450px] bg-no-repeat bg-fixed " style={{ backgroundImage: `url('./assets/img-home.jpg')` }}>
                        <div className="p-5 bg-black bg-opacity-70 pt-5 flex items-center flex-col lg:w-[60%] lg:ml-[20%] ">
                            ...
                            <h2 className="text-xl  text-white lg:text-3xl italic lg:pb-5">Where every sip tells a story</h2>
                            <h3 className="text-white lg:text-xl mt-5">At Wineder, we believe that wine is more than just a drink: it’s an experience, a tradition, and a celebration of life. We are dedicated to offering you a carefully curated selection of the finest wines from the most prestigious wineries, both national and international.</h3>
                        </div>
                    </div>
                    ...
                    <section className="m-5 lg:w-[80%] lg:justify-center lg:pl-[10%] ">
                        <h3 className='text-3xl italic'>Our Selection</h3>
                        ...
                        <h3 className='text-3xl italic'>Our Promise</h3>
                        ...
                        <h3 className='text-3xl italic'>Join Our Community</h3>
                    ...
                    <section className="flex flex-col md:flex-row md:flex-wrap justify-around items-center py-5 gap-4 m ">
