...
const CartsWines = ({ bgColor, ...props }) => {
    ...
    switch (bgColor) {
        case 'WHITE':
            bgColorClass = "bg-[#D4B891]";
            break;
        case 'RED':
            bgColorClass = "bg-[#5e2a30]";
            break;
        case 'PINK':
            bgColorClass = "bg-[#DCC8C9]";
            break;
        case 'SPARKLING':
            bgColorClass = "bg-[#A39D92]";
            break;
    }
    ...
    return (
        <>
            ...
            <div className={`relative group cursor-pointer overflow-hidden duration-500 w-64 h-64 ${bgColorClass} text-black rounded-lg p-5`}>
                <div>
